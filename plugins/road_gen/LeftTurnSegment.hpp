...
class LeftTurnSegment : public RoadSegment
{
public:
    LeftTurnSegment(gz::math::Vector3<float> _pos, gz::math::Vector3<float> _rot) : RoadSegment(_pos, _rot) 
    {
        ...
        lines.push_back(new DashedLine(getId(), 
                ...
                gz::math::Vector3<float>(7.0, 9.0, 0.01),
                pos,
                rot,
                -90));
    }
